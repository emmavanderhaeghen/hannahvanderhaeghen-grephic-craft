  ...
  addEventListeners() {
    this.button.addEventListener('click', () => {
      ...
      if (this.button.classList.contains('open')) {
        gsap.to(this.lines[0], { duration: 0.2, rotate: '45deg', top: '8px' });
        gsap.to(this.lines[1], { duration: 0.2, rotate: '-45deg', bottom: '2px' });
      } else {
        gsap.to(this.lines[0], { duration: 0.2, rotate: '0deg', top: '0' });
        gsap.to(this.lines[1], { duration: 0.2, rotate: '0deg', top: '0' });
      }
    });
  } 
