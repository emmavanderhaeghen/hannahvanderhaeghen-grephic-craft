    ...
    value: function initOpenNav() {
      ...
      this.navBtn.addEventListener('click', function () {
        ...
        if (_this.navBtn.classList.contains('open')) {
          ...
          gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(_this.lines[1], {
            duration: 0.2,
            rotate: '-45deg',
            bottom: '2px',
            backgroundColor: 'white'
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkhannahvanderhaeghen"] = self["webpackChunkhannahvanderhaeghen"] || [];
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["app"], () => (__webpack_require__("./src/styles/styles.css")))
